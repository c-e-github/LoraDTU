...
private:
    ...
    void addCEField(JsonObject& root, const String& name, const bool wert); 
    void addCETextField(JsonObject& root, const String& name, const String& wert); 
    void addDayField(JsonObject& root, uint8_t idx, std::shared_ptr<InverterAbstract> inv, const ChannelType_t type, const ChannelNum_t channel, const FieldId_t fieldId, String topic = "");
