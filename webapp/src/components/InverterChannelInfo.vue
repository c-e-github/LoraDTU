...
<!-- auskommentiert, um Anzeige "Allgemein" verhindern  
...
<!-- div eingefügt, um Anzeige "Allgemein" verhindern  -->
        <div v-if="channelType != 'INV'">
           <div class="card-body">
        ...
        </div> <!-- div eingefügt, um Anzeige "Allgemein" verhindern  -->
    </div>
</template>
