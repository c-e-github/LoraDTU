...
<!--    <nav class="navbar navbar-expand-md fixed-top bg-body-tertiary" data-bs-theme="dark"> -->
        <div class="container-fluid">
            ...
            <span id="modusanzeige" style="font-size: 1.25rem; text-align: left"> Modusanzeige </span>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                            ...
                            <li>
                                <router-link @click="onClick" class="dropdown-item" to="/about">{{ $t('menu.About') }}</router-link>
                            </li>
                        </ul>
